...
int case_u(va_list args, int length_mod, int flag_hash, int field_width); /* Handles 'u' format specifier */

int case_x(va_list args, int length_mod, int flag_hash, int field_width, int uppercase); /* Handles 'x' format specifier */

int case_X(va_list args, int length_mod, int flag_hash, int field_width, int uppercase); /* Handles 'X' format specifier */

int case_p(va_list args, const char *format); /* Handles 'p' format specifier */

int case_o(va_list args, int length_mod, int flag_hash, int field_width); /* Handles 'o' format specifier */
